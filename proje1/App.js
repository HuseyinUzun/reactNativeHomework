...
import { Image, Button, StyleSheet, Text, TouchableOpacity, View, ScrollView } from 'react-native';
...
const medicineIcon1 = require('./images/medicine1.png');
const medicineIcon2 = require('./images/medicine2.png');
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <View style={styles.leftHeader}>
          <View style={styles.image}>
            <Image style={styles.imageURL} source={{ uri: 'https://image.shutterstock.com/mosaic_250/2780032/1854697390/stock-photo-head-shot-young-attractive-businessman-in-glasses-standing-in-modern-office-pose-for-camera-1854697390.jpg' }} />
          </View>
          <Text style={styles.name}>Hüseyin Uzunluöz
        ...
        <View style={styles.userContent}>
          <View style={styles.userInfo}>
            ...
            <View style={styles.userText}>
              <Text style={styles.userName}>Dt. Mehmet Akif Ersoy</Text>
              <Text style={styles.userJop}>Therapist</Text>
              <View style={styles.userPoint}>
                <View style={styles.star}>
                  <Image style={styles.starIcon} source={starIcon} />
                </View>
                <Text style={styles.point}>4.6</Text>
              </View>
            </View>
      ...
      <ScrollView horizontal><View style={styles.kutucuklar}>
        <View style={styles.coldact}>
          <View style={styles.coldactIconContainer}><Image style={styles.coldactIcon}  /></View>
